...
const Hero = () => {
  return (
    <>
      <div className="min-h-[100vh] relative  w-full flex flex-col  justify-center items-center  ">
        <motion.div
      ...
      flex flex-col sm:flex-row justify-center items-center sm:gap-4"
        ...
        text-white px-4 py-[12px] md:py-3 rounded-full"
         ...
         /> */}
          ...
          hover:bg-gradient-to-r active:scale-95 flex justify-center items-center gap-2  hover:scale-105 hover:from-pr1 hover:to-sec1"
          >
            Short Overview <BiSolidSend className="text-2xl " />
          </button>
        </div>
